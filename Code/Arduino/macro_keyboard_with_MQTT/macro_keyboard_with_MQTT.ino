...
EspMQTTClient client(
  ...
  "192.168.1.204",  // MQTT Broker server ip (REPLACE WITH YOURS)
  "MQTT_USERNAME",   // Can be omitted if not needed
  "MQTT_USERNAME",   // Can be omitted if not needed
  "Open Deck"      // Client name that uniquely identify your device
);
...
int orientation = 0; //2 for normal 0 for inverted
/////////////////////////////////////
...
void setup(void) {
  ...
  tft.setRotation(orientation);  //invert diaply orientation
...
//  client.subscribe("open_deck/buttons", [] (const String &payload)  {
//    Serial.println(payload);
//  });

  client.publish("open_deck/buttons", "Connected");
}
...
void loop() {
    ...
    if (orientation == 2){
      TLState = digitalRead(TL);
      BRState = digitalRead(BR);
      TRState = digitalRead(TR);
      BLVal = analogRead(BL);  //analog read as not enough digital pins :(
      BLState = (BLVal>500);
    } else if (orientation == 0){
      TLState = digitalRead(BR);
      BRState = digitalRead(TL);
      BLState = digitalRead(TR);
      TRVal = analogRead(BL);  //analog read as not enough digital pins :(
      TRState = (TRVal>500);
    }
    ...
    //Menu 1        
      ...
      Serial.println("1");
      client.publish("open_deck/buttons", "1");
      delay(150);
      if (orientation == 2){
        while(!TLState){ TLState = digitalRead(TL);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
        while(!TLState){ TLState = digitalRead(BR);delay(10);}
      }
      ...
      Serial.println("2");
      client.publish("open_deck/buttons", "2");
      delay(150);
      if (orientation == 2){
        while(!TRState){ TRState = digitalRead(TR);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
        while(!TRState){ TRState =  TRVal = analogRead(BL); TRState = (TRVal>500); delay(10);}
      }
      ...
      Serial.println("3");
      client.publish("open_deck/buttons", "3");
      delay(150);
      if (orientation == 2){
        while(!BRState){ BRState = digitalRead(BR);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
        while(!BRState){ BRState = digitalRead(TL);delay(10);}
      }
    ...
    //Menu 2
      ...
      Serial.println("4");
      client.publish("open_deck/buttons", "4");
      delay(150);
      if (orientation == 2){
        while(!TLState){ TLState = digitalRead(TL);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
      ...
      Serial.println("5");
      client.publish("open_deck/buttons", "5");
      delay(150);
      if (orientation == 2){
        while(!TRState){ TRState = digitalRead(TR);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
      ...
      Serial.println("6");
      client.publish("open_deck/buttons", "6");
      delay(150);
      if (orientation == 2){
        while(!BRState){ BRState = digitalRead(BR);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
    ...
    //Menu 3
      ...
      Serial.println("7");
      client.publish("open_deck/buttons", "7");
      delay(150);
      if (orientation == 2){
        while(!TLState){ TLState = digitalRead(TL);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
      ...
      Serial.println("8");
      client.publish("open_deck/buttons", "8");
      delay(150);
      if (orientation == 2){
        while(!TRState){ TRState = digitalRead(TR);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
      ...
      Serial.println("9");
      client.publish("open_deck/buttons", "9");
      delay(150);
      if (orientation == 2){
        while(!BRState){ BRState = digitalRead(BR);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
    ...
    //Menu 4 (task manger)
      ...
      Serial.println("10");
      client.publish("open_deck/buttons", "10");
      delay(150);
      if (orientation == 2){
        while(!TLState){ TLState = digitalRead(TL);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
      ...
      Serial.println("11");
      client.publish("open_deck/buttons", "11");
      delay(150);
      if (orientation == 2){
        while(!TRState){ TRState = digitalRead(TR);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
      ...
      Serial.println("12");
      client.publish("open_deck/buttons", "12");
      delay(150);
      if (orientation == 2){
        while(!BRState){ BRState = digitalRead(BR);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
    ...
    //Menu 5
      ...
      Serial.println("13");
      client.publish("open_deck/buttons", "13");
      delay(150);
      if (orientation == 2){
        while(!TLState){ TLState = digitalRead(TL);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
      ...
      Serial.println("14");
      client.publish("open_deck/buttons", "14");
      delay(150);
      if (orientation == 2){
        while(!TRState){ TRState = digitalRead(TR);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
      ...
      Serial.println("15");
      client.publish("open_deck/buttons", "15");
      delay(150);
      if (orientation == 2){
        while(!BRState){ BRState = digitalRead(BR);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
    ...
    //Menu 6
      ...
      Serial.println("16");
      client.publish("open_deck/buttons", "16");
      delay(150);
      if (orientation == 2){
        while(!TLState){ TLState = digitalRead(TL);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
      ...
      Serial.println("17");
      client.publish("open_deck/buttons", "17");
      delay(150);
      if (orientation == 2){
        while(!TRState){ TRState = digitalRead(TR);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
      ...
      Serial.println("18");
      client.publish("open_deck/buttons", "18");
      delay(150);
      if (orientation == 2){
        while(!BRState){ BRState = digitalRead(BR);delay(10);}
      }  else if (orientation == 0){ //work around for analog read 
